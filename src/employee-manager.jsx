...
// 초기 데이터
// ───────────────────────────────────────────────────────────
const RANKS = ["사원", "대리", "과장", "차장", "부장", "수석", "책임", "선임"];
const AFFILIATIONS = ["IBKS", "협력사"];
const SAMPLE_PARTNERS = ["LG CNS", "삼성SDS", "SK C&C", "롯데정보통신", "포스코DX", "한화시스템", "대우정보시스템", "아이티센"];
const SAMPLE_DUTIES = ["개발", "분석/설계", "기획", "PM", "PL", "아키텍트", "DBA", "테스트", "운영", "인프라", "보안", "UI/UX"];
const SAMPLE_ROLES = ["프로젝트 총괄", "파트 리더", "백엔드 개발", "프론트엔드 개발", "풀스택 개발", "DB 설계", "요구사항 분석", "화면 설계", "테스트 자동화", "시스템 운영", "기술 검토", "품질 관리"];

// 투입 형태
const ASSIGNMENT_TYPES = ["계약", "비계약", "지원"];
...
// 직급 정렬 우선순위 (낮을수록 상위)
const RANK_ORDER = { "부장": 1, "수석": 2, "책임": 3, "차장": 4, "선임": 5, "과장": 6, "대리": 7, "사원": 8 };
...
const GIVEN_NAMES = ["민수", "지훈", "서연", "예준", "도윤", "시우", "하준", "주원", "지호", "건우", "현우", "우진", "선우", "연우", "유준", "정우", "승현", "태민", "재현", "동현", "수빈", "지민", "하은", "서윤", "지우", "채원", "수아", "예린", "나연", "소율"];
...
const COLOR_OPTIONS = Object.keys(COLOR_MAP).filter(c => c !== "slate");
